...
#define GPSLAMB3                                                                                                                           \
    (((G01_F * G01_F) / (G01_F * G01_F - G02_F * G02_F)) * GPSLAMB1 -                                                                      \
     ((G02_F * G02_F) / (G01_F * G01_F - G02_F * G02_F)) * GPSLAMB2) ///< GPS ionospher-free wave lenght [m]
