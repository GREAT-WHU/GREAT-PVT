...
namespace gnut
{
    ...
    public:
        ...
        void anten(const string& s)
        {
            _anten = s;
        }
        const string& anten() const
        {
            return _anten;
        }

        /** @brief set/get antenna identification (ATX field 20-39). */
        void ident(const string& s)
        {
            _ident = s;
        }
        ...
        void snxcod(const string& s)
        {
            _snxcod = s;
        }
        const string& snxcod() const
        {
            return _snxcod;
        }

        /** @brief set/get valid from. */
        void beg(const t_gtime& t)
        {
            _beg = t;
        }
        const t_gtime& beg() const
        {
            return _beg;
        }

        /** @brief set/get valid until. */
        void end(const t_gtime& t)
        {
            _end = t;
        }
        ...
        void dazi(const double& d)
        {
            _dazi = d;
        }
        const double& dazi() const
        {
            return _dazi;
        }

        /** @brief set/get zenith sampling. */
        void dzen(const double& d)
        {
            _dzen = d;
        }
        const double& dzen() const
        {
            return _dzen;
        }

        /** @brief set/get zenith1. */
        void zen1(const double& d)
        {
            _zen1 = d;
        }
        const double& zen1() const
        {
            return _zen1;
        }

        /** @brief set/get zenith2. */
        void zen2(const double& d)
        {
            _zen2 = d;
        }
        const double& zen2() const
        {
            return _zen2;
        }
        ...
        /** @brief set/get PCO. */
        void pco(GFRQ f, const t_gtriple& t)
        {
            _mappco[f] = t;
        }
        t_gtriple pco(GFRQ f)
        {
            return _mappco[f];
        }
        t_map_pco pco() const
        ...
        void pcvzen(GFRQ f, const t_map_Z& t)
        {
            _mapzen[f] = t;
        }
        t_map_Z pcvzen(GFRQ f)
        {
            return _mapzen[f];
        }
        t_map_zen pcvzen() const
        {
            return _mapzen;
        }

        /** @brief set/get PCO aiz. */
        void pcvazi(GFRQ f, const t_map_A& t)
        {
            _mapazi[f] = t;
        }
        t_map_A pcvazi(GFRQ f)
        {
            return _mapazi[f];
        }
        t_map_azi pcvazi() const
        {
            return _mapazi;
        }
        void is_noazi(bool b)
        {
            _pcv_noazi = b;
        }
