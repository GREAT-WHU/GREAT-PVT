...
namespace gnut
{
    ...
    {
        t_gtriple var(_xyz_rms[0] * _xyz_rms[0], _xyz_rms[1] * _xyz_rms[1], _xyz_rms[2] * _xyz_rms[2]);
    ...
    {
        t_gtriple var(_apr_rms[0] * _apr_rms[0], _apr_rms[1] * _apr_rms[1], _apr_rms[2] * _apr_rms[2]);
