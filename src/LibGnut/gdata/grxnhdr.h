...
namespace gnut
{
    ...
    public:
         ...
         */
        const vector<string>& comment() const
        {
            return _comment;
        } ///< get comment
         ...
         * @param ts
         */
        void tsys_corr(const TSYS_CORR& c,
                       const t_tsys_corr& ts); ///< set sys_corr
         ...
         * @param io
         */
        void iono_corr(const IONO_CORR& c,
                       const t_iono_corr& io); ///< set iono_corr
