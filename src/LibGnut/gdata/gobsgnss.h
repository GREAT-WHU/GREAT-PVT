...
namespace gnut
{
    ...
    public:
        ...
        /** @brief gppflt NEW! */
        GOBS id_range(const GOBSBAND& b) const
        {
            return _id_range(b);
        };
         ...
         * @return GOBS
         */
        GOBS id_phase(const GOBSBAND& b) const
        {
            return _id_phase(b);
        };
         ...
         * @param mark
         */
        void reset_dcbmark(const bool& mark)
        {
            _dcb_correct_mark = mark;
        };
         ...
         * @return double
         */
        double isf_lc(const int& band1, const double& coef1, const int& band2, const double& coef2) const;
         ...
         * @return double
         */
        double MP(const t_gobs& code, const t_gobs& L1, const t_gobs& L2) const;
        /**
         * @brief GFIF meter
         *
         * @param gL1
         ...
         * @return double
         */
        double MW(const t_gobs& g1, const t_gobs& g2, bool phacode_consistent = false) const;
         ...
         * @return double
         */
        double MW_cycle(const t_gobs& gL1, const t_gobs& gL2, const t_gobs& gC1, const t_gobs& gC2) const;
         ...
         * @return double
         */
        double EWL_cycle(const t_gobs& gL1, const t_gobs& gL2, const t_gobs& gL3, const t_gobs& gC1, const t_gobs& gC2) const;
         ...
         * @return int
         */
        int coef_ionofree(const GOBSBAND& b1, double& c1, const GOBSBAND& b2, double& c2) const;
         ...
         * @return int
         */
        int coef_ionofree_phi(const GOBSBAND& b1, double& c1, const GOBSBAND& b2, double& c2) const;
         ...
         * @return int
         */
        int coef_geomfree(const GOBSBAND& b1, double& c1, const GOBSBAND& b2, double& c2) const;
         ...
         * @return int
         */
        int coef_narrlane(const GOBSBAND& b1, double& c1, const GOBSBAND& b2, double& c2) const;
         ...
         * @return int
         */
        int coef_widelane(const GOBSBAND& b1, double& c1, const GOBSBAND& b2, double& c2) const;
    ...
    protected:
         ...
         * @return double
         */
        double _lcf_range(const t_gobs* g1, const int& cf1, const t_gobs* g2, const int& cf2, const t_gobs* g3 = 0, const int& cf3 = 0)
            const;
         ...
         * @return double
         */
        double _lcf_phase(const t_gobs* g1, const int& cf1, const t_gobs* g2, const int& cf2, const t_gobs* g3 = 0, const int& cf3 = 0)
            const;
         ...
         * @return double
         */
        double _lc_range(const t_gobs* g1,
                         const double& cf1,
                         const t_gobs* g2,
                         const double& cf2,
                         const t_gobs* g3 = 0,
                         const double& cf3 = 0) const;
         ...
         * @return double
         */
        double _lc_phase(const t_gobs* g1,
                         const double& cf1,
                         const t_gobs* g2,
                         const double& cf2,
                         const t_gobs* g3 = 0,
         ...
         * @return int
         */
        int _coef_multpath(const GOBSBAND& bC, double& cC, const GOBSBAND& b1, double& c1, const GOBSBAND& b2, double& c2) const;
         ...
         * @return int
         */
        int _coef_ionofree(const GOBSBAND& b1, double& c1, const GOBSBAND& b2, double& c2) const;
         ...
         * @return int
         */
        int _coef_geomfree(const GOBSBAND& b1, double& c1, const GOBSBAND& b2, double& c2) const;
         ...
         * @return int
         */
        int _coef_narrlane(const GOBSBAND& b1, double& c1, const GOBSBAND& b2, double& c2) const;
         ...
         * @return int
         */
        int _coef_widelane(const GOBSBAND& b1, double& c1, const GOBSBAND& b2, double& c2) const;
