...
namespace gnut
{
    ...
    public:
        ...
        virtual int data2nav(string sat, const t_gtime& ep, const t_gnavdata& data)
        {
            return -1;
        }

        /** @brief convert nav to data. */
        virtual int nav2data(t_gnavdata& data)
        {
            return -1;
        }
        ...
        /** @brief get rec. */
        virtual int rec() const
        {
            return MAX_RINEXN_REC;
        }
        ...
        virtual string health_str() const override
        {
            return _health_str();
        }

        /** @brief get chk. */
        virtual int chk(set<string>& msg)
        {
            return 1;
        }

        /** @brief get the number of frequency. */
        virtual int freq_num() const
        {
            return 255;
        }
    ...
    protected:
        ...
        virtual bool _healthy() const
        {
            return true;
        }

        /** @brief convert health to string. */
        virtual string _health_str() const
        {
            return "";
        }
