...
namespace great
{
    ...
    public:
        ...
        virtual double get_rec_clk(const string& obj)
        {
            return 0.0;
        };
    ...
    protected:
         ...
         */
        virtual double cmpObs(t_gtime& epoch, string& sat, string& rec, t_gallpar& param, t_gsatdata& gsatdata, t_gobs& gobs)
        {
            return 0.0;
        };
