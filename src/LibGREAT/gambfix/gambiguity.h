...
namespace great
{
    ...
    public:
         ...
         */
        void setMW(map<string, map<int, double>>& MW)
        {
            _MW = MW;
        }
         ...
         * @param[in] t_map_MW& MW
         */
        void setELE(const map<string, double>& crt_ele)
        {
            _ELE = crt_ele;
        }
        void setSNR(const map<string, map<FREQ_SEQ, double>>& crt_snr)
        {
            _SNR = crt_snr;
        }
         ...
         */
        void setObsType(OBSCOMBIN type)
        {
            _obstype = type;
        }
        ...
        void setActiveAmb(int max)
        {
            _max_active_amb_one_epo = max;
        }
    ...
    protected:
        ...
        /**
         * @brief check if a new ambiguity is dependant of the already selected set expressed by a set of orth. unit
         * vector Ei.
         ...
         * @param[in] iMaxamb_ow         number of total number of ow-ambiguties for the differenced ambiguties to be
         * checked, not zero, for allocation, zero for check.
         * @param[in] iMaxamb_for_check  number of the total independent ones of the checked set, only used for the
         * allocaiton .
         * @param[out] iNdef
        ...
        */
        ...
        /**
         * @brief get covariance-matrix for or DD-ambiguities based on the defined DD-ambiguities and the Qx with
         * oneway.
