...
namespace great
{
    ...
    public:
        ...
        /*static void LAMBDA4(int iMaxcan, int n, double *arrdQ, double* arrdA, int* iNcan, int* iPos, double*
        arrdCands, double* arrdIsall); static void STOREs(int iCan, int iPos, int *piMax, double t, double *pdTmax,
        double *arrpdDist, double *arrpdDisall, double *arrpdCands, int iMaxCan, int n);*/
         ...
         * @param[in] piMax        position in disall/cands of the vector with the largest distance of the ican vectors
         ...
         * @param[in] pdTmax     the largest distance of the Min (ncan,MaxCan) vectors with minimum distance found until
         * now
         * @param[in] piMax  position in disall/cands of the vector with the largest distance of the Min (ncan,MaxCan)
         * vectors with minimum distance found until now
         * @param[out] pdDist pdEnd_1 piNcan pdDisall  pdCands pdTmax  piMax
         * @return void
         */
        void COLLECTs(int iN,
                      int iMaxCan,
                      double dD_1,
                      double dLef_1,
                      double dLeft_1,
        ...
        /**
         * @brief transpose(L) D L factorization of Q, L over-writes Q bordering method, computation of Googe number
         * (section 3.3)s.
         ...
         *                    program L is stored column-wise in a 2-dimensional array, to avoid the necessity of a
        ...
        /**
         * @brief takes inproduct of column 'icol' of triangular unit matrix L and vector a (exclusive the diagonal
         * element).
        ...
        /**
         * @brief finds 'MaxCan' integer vectors whose distance to the the real vector 'a' is minimal in the metric of
         * Q=transpose(L) D L. Only integer vectors with a distance less than sqrt(Chic) are regarded.
         * @param[in] dChic      Chi squared
         * @param[in] iMaxCan    number of minimum integer vectors requiered
         * @param[in] iN            dimension of matrix
         ...
         * @param[in] piPos        column number in 'cands' where the candidate belonging to the minimum distance is
         * stored
         * @param[out] pdA, pdD, dpdL, pdLef, pdLeft, pdRight,pdDist, pdEnd, pdDq, ipiNcan, pdDisall, pdCands, piPos
         * @return void
         */
        void FI71(double dChic,
                  int iMaxCan,
                  int iN,
                  double* pdA,
                  double* pdD,
