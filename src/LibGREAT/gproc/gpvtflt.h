...
namespace great
{
    ...
    public:
         ...
         * @return void
         */
        void Add_rho_azel(/*const t_gtime &runEpoch, */ const string& site_name,
                          t_gtriple& xyz_s,
                          const t_gtriple& xyz_r,
                          t_gsatdata& obs_sat);
         ...
         */
        void setRefsat(map<GSYS, string> satref)
        {
            _ipSatRep = satref;
        }
    ...
    protected:
         ...
         * @return retval > 0,success; retval < 0,fail
         */
        int _addObsD(t_gsatdata& satdata,
                     unsigned int& iobs,
                     t_gallpar& param,
                     t_gtriple& XYZ,
                     Matrix& A,
        ...
        virtual void _prtOut(t_gtime& epo,
                             t_gallpar& X,
        ...
        void _posterioriTest(const Matrix& A,
    ...
    template <class T1, class T2> void t_out(T1 const& name, T2 const& matrix)
    {
        cout << name << endl;
